...
def compare_embeddings(sentence1, sentence2):
    """
    Compare two sentences using embeddings and calculate similarity.
    Args:
...
def compare_sentences(sentence1, sentence2, category, subcategory):
    """Compare two sentences and return their cosine similarity"""
    embeddings = compare_embeddings(sentence1, sentence2)
    return {
        'Category': category,
...
for test_name, test_sentence in capitalization_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Capitalization", test_name))
...
for test_name, test_sentence in whitespace_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Whitespace", test_name))
...
for test_name, test_sentence in negation_tests:
    results.append(compare_sentences(negation_base, test_sentence, "Negation", test_name))
...
for test_name, test_sentence in special_chars_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Special Characters", test_name))
...
for test_name, test_sentence in word_order_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Word Order", test_name))
...
for test_name, test_sentence in synonyms_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Synonyms & Paraphrasing", test_name))
...
for test_name, test_sentence in spelling_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Spelling & Typos", test_name))
...
for test_name, test_sentence in entity_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Named Entities", test_name))
...
for test_name, test_sentence in grammar_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Grammar", test_name))
...
for test_name, test_sentence in filler_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Verbosity", test_name))
...
for test_name, test_sentence in contraction_tests:
    results.append(compare_sentences(contraction_base, test_sentence, "Contractions", test_name))
...
for test_name, test_sentence in missing_info_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Missing Information", test_name))
...
for test_name, test_sentence in language_tests:
    results.append(compare_sentences(base_sentence, test_sentence, "Language Mixing", test_name))
...
for test_name, test_sentence in temporal_direction:
    results.append(compare_sentences(base_sentence, test_sentence, "temporal_direction", test_name))
###
...
for test_name, test_sentence in quant_threshold:
    results.append(compare_sentences(base_sentence, test_sentence, "quant_threshold", test_name))
###
...
for test_name, test_sentence in hypo_fact:
    results.append(compare_sentences(base_sentence, test_sentence, "hypo_fact", test_name))
###
...
for test_name, test_sentence in scaler_inversion:
    results.append(compare_sentences(base_sentence, test_sentence, "scaler_inversion", test_name))
###
...
for test_name, test_sentence in medicine_domain_based:
    results.append(compare_sentences(base_sentence, test_sentence, "medicine_domain_based", test_name))
###
...
for test_name, test_sentence in legal_domain_based:
    results.append(compare_sentences(base_sentence, test_sentence, "legal_domain_based", test_name))
###
...
for test_name, test_sentence in attribution:
    results.append(compare_sentences(base_sentence, test_sentence, "attribution", test_name))
###
...
for test_name, test_sentence in numerical:
    results.append(compare_sentences(base_sentence, test_sentence, "Numerical", test_name))
###
...
for test_name, test_sentence in unit_conversion:
    results.append(compare_sentences(base_sentence, test_sentence, "unit_conversion", test_name))
###
...
for test_name, test_sentence in miles:
    results.append(compare_sentences(base_sentence, test_sentence, "miles", test_name))
###
...
for test_name, test_sentence in exact:
    results.append(compare_sentences(base_sentence, test_sentence, "exact", test_name))
###
...
for test_name, test_sentence in domain_significance:
    results.append(compare_sentences(base_sentence, test_sentence, "domain_significance", test_name))
###
...
for test_name, test_sentence in Percentages:
    results.append(compare_sentences(base_sentence, test_sentence, "Percentages", test_name))
###
...
for test_name, test_sentence in date_time:
    results.append(compare_sentences(base_sentence, test_sentence, "date_time", test_name))
###
...
for test_name, test_sentence in stats:
    results.append(compare_sentences(base_sentence, test_sentence, "stats", test_name))
###
...
for test_name, test_sentence in Counterfactual:
    results.append(compare_sentences(base_sentence, test_sentence, "Counterfactual", test_name))
###
...
for test_name, test_sentence in Taxonomic:
    results.append(compare_sentences(base_sentence, test_sentence, "Taxonomic", test_name))
###
...
for test_name, test_sentence in Procedural:
    results.append(compare_sentences(base_sentence, test_sentence, "Procedural", test_name))
###
...
for test_name, test_sentence in Comparison:
    results.append(compare_sentences(base_sentence, test_sentence, "Comparison", test_name))
###
...
for test_name, test_sentence in Metaphorical:
    results.append(compare_sentences(base_sentence, test_sentence, "Metaphorical", test_name))
###
...
for test_name, test_sentence in Presupposition:
    results.append(compare_sentences(base_sentence, test_sentence, "Presupposition", test_name))
###
...
for test_name, test_sentence in Reference:
    results.append(compare_sentences(base_sentence, test_sentence, "Reference", test_name))
###
...
for test_name, test_sentence in Extensional:
    results.append(compare_sentences(base_sentence, test_sentence, "Extensional", test_name))
###
...
plt.savefig(f"{output_dir}/embedding_comparisons_openai.png")

# Print summary statistics by category
print(df.groupby('Category')['Similarity'].describe())

# Save results to CSV
df.to_csv(f"{output_dir}/embedding_comparison_results_openai.csv", index=False)
